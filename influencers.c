...
const int DIA_CAM_VIENTO_MAX = 11;
const int DIA_CAM_VIENTO_MED = 21;
const int SUENIO_MIN = 0;
const int SUENIO_MAX = 12;
const int HORA_CAM_SUENIO_MIN = 5;
const int HORA_CAM_SUENIO_MED = 8;
const int VIENTO_MAX = 75;
const int VIENTO_MED = 50;
const int VIENTO_MIN = 25;
const int HUMADAD_MAX = 75;
const int HUMEDAD_MED = 50;
const int HUMEDAD_MIN = 25;
const int PUNTOS_PIE_DER = 10;
const int PUNTOS_ENSALADA = 20;
const int PUNTOS_HAMBURGUESA = 15;
const int PUNTOS_PIZZA = 10;
const int PUNTOS_GUISO = 5;
const int PUNTOS_SUENIO_MED = 10;
const int PUNTOS_SUENIO_MAX = 20;
const int CONTADOR_INICIAL = 0;
const int PUNTOS_MIN_ANIMO = 5;
const int PUNTOS_CAM_ANIMO_MALO = 21;
const int PUNTOS_CAM_ANIMO_REG = 35;
...
int main (){
	...
	int viento = viento_segun_dia_del_mes (dia_del_mes);
	int humedad = humedad_segun_hora (hora);
	...
	calcular_animo (&animo_legolas, puntos_legolas);
	calcular_animo (&animo_gimli, puntos_gimli);
